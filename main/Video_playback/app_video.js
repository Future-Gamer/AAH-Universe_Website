...
=======
          window.location = "/main/index_anime.html"
>>>>>>> 0d473b4d6e6342a6ce45138181a0554836fb5edf
}
...
=======
document.getElementsByClassName('video-file').addEventListener('contextmenu', function (event) {
          event.preventDefault();
});

// Prevent keyboard shortcuts for saving
document.getElementsByClass('video-file').addEventListener('keydown', function (event) {
          if (event.ctrlKey && event.key === 's') {
                    event.preventDefault();
          }
>>>>>>> 0d473b4d6e6342a6ce45138181a0554836fb5edf
...
window.addEventListener('load', function() {
          ...
          elements.forEach(function(element) {
                    element.addEventListener('click', function(event) {
                              changeVideoOnClick(event, '/Trailer/bad_boys_ride_or_die.mp4')
                    });
          });
});
>>>>>>> 0d473b4d6e6342a6ce45138181a0554836fb5edf
